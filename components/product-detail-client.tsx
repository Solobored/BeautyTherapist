        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
            ...
            <div>
              ...
              <h1 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-4">{displayName}</h1>
          ...
          <Tabs defaultValue="description" className="mb-16">
            ...
            <TabsContent value="ingredients" className="pt-6">
              <p className="text-muted-foreground leading-relaxed max-w-3xl whitespace-pre-wrap">{product.ingredients || '—'}</p>
            </TabsContent>

            <TabsContent value="how-to-use" className="pt-6">
              <p className="text-muted-foreground leading-relaxed max-w-3xl whitespace-pre-wrap">{displayHowTo || '—'}</p>
            </TabsContent>
          ...
          {relatedProducts.length > 0 && (
            <section>
              <h2 className="font-serif text-2xl font-semibold text-foreground mb-6">{t('product.relatedProducts')}</h2>
